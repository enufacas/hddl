...
```bash
cd hddl-sim
.\deploy-api\deploy.ps1    # Windows PowerShell
# OR
./deploy-api/deploy.sh     # macOS/Linux/WSL
```
...
### New Files
- `hddl-sim/deploy-api/deploy.sh` - Bash deployment script
- `hddl-sim/deploy-api/deploy.ps1` - PowerShell deployment script
- `hddl-sim/deploy-api/GUIDE.md` - Complete deployment guide
- `hddl-sim/deploy-api/README.md` - Quick start summary
...
**Full Guide:** `deploy-api/GUIDE.md`
